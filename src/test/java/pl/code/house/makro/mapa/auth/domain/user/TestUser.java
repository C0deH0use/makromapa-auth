...
public class TestUser {
  ...
  public static ExternalMockUser GOOGLE_NEW_USER = new ExternalMockUser(null, "Makro Mapa", "104796865881481034300", NEW_USER_TOKEN);
  public static ExternalMockUser GOOGLE_PREMIUM_USER = new ExternalMockUser("aa6641c1-e9f4-417f-adf4-f71accc470cb", "Makromapa Test01", "118364847911502210416",
      PREMIUM_USER_TOKEN);

  public static ExternalMockUser APPLE_NEW_USER = new ExternalMockUser(null, null, "000807.4f911cd6e03a4ebb933c4e099a7ad710.2158", APPLE_USER_TOKEN);
  ...
  public static class ExternalMockUser extends BaseMockUser {
    ...
    public ExternalMockUser(String userId, String name, String externalId, String jwt) {
      super(userId, name);
